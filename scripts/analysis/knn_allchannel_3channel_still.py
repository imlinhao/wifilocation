...
if __name__ == '__main__':
	...
	ALLCHANNEL_ONLINE_STILLTIME_FN = DATA_ROOT+"/2013_12_4_21_42_49/stilltime.txt"
	ALLCHANNEL_ONLINE_QUERY_FN = DATA_ROOT+"/2013_12_4_21_42_49/wifi.txt"
	...
	THREECHANNEL_ONLINE_QUERY_FN = DATA_ROOT+"/2013_12_4_21_1_46/getscanJNI.txt"
	loc_list = range(0,51)
	...
	query_list = get_allchannel_still_query_list(ALLCHANNEL_ONLINE_QUERY_FN, online_stilltime_list, loc_list)
	...
	threechannel_query_list = get_3channel_still_query_list(THREECHANNEL_ONLINE_QUERY_FN, threechannel_online_stilltime_list, loc_list)
